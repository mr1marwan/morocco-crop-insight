        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-3">
              <a
                href="https://github.com/mr1marwan"
                target="_blank"
                rel="noopener noreferrer"
                className={`transition-colors ${
                  darkMode
                    ? 'text-gray-400 hover:text-green-400'
                    : 'text-gray-600 hover:text-morocco-green'
                }`}
                aria-label="GitHub"
              ...
              <a
                href="https://www.linkedin.com/in/marouane-ait-hammou/"
                target="_blank"
                rel="noopener noreferrer"
                className={`transition-colors ${
                  darkMode
              ...
              <a
                href="mailto:marouaneaithammou3@gmail.com"
                className={`transition-colors ${
                  darkMode
                    ? 'text-gray-400 hover:text-green-400'
                    : 'text-gray-600 hover:text-morocco-green'
